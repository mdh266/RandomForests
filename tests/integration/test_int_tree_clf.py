...
get_split_tests = [
    (
        ...
        np.array([[0.1, 0], [0.5, 0], [0.7, 1], [0.9, 1]]),
        {
            ...
            "value": 0.7,
            "groups": (
                np.array([[0.1, 0.0], [0.5, 0.0]]),
                np.array([[0.7, 1.0], [0.9, 1.0]]),
            ),
        },
    ),
    (
        ...
        np.array([[0, 0.1, 0], [0, 0.5, 0], [0, 0.7, 1], [0, 0.9, 1]]),
        {
            ...
            "value": 0.7,
            "groups": (
                np.array([[0.0, 0.1, 0.0], [0.0, 0.5, 0.0]]),
                np.array([[0.0, 0.7, 1.0], [0.0, 0.9, 1.0]]),
            ),
        },
    ),
]
    ...
    (
        {
            "column": 0,
            "value": 0.0,
            "groups": (np.array([]), np.array([[0.0, 0.1, 0], [0.0, 0.5, 0]])),
        },
        1,  # depth
    ...
    (
        {
            ...
            "value": 9.0,
            "groups": (
                np.array([[0, 1, 1], [0.0, 0.5, 1]]),
                np.array([[0, 1, 0], [0.0, 0.5, 0]]),
            ),
        },
        2,  # depth
    ...
    (
        {
            ...
            "groups": (
                np.array([[0.0, 0.1, 0]]),
                np.array([[0.0, 0.7, 1], [0.0, 0.8, 0], [0.0, 0.9, 1]]),
            ),
        },
        2,  # depth
...
public_predict_test = [
    (
        np.array([[0.0, 0.1], [0.0, 0.5], [0.0, 0.7], [0.0, 0.9]]),
        np.array([0, 0, 1, 1]),
    ),  # y
    (
        pd.DataFrame({"c1": [0.0, 0.0, 0.0, 0.0], "c2": [0.1, 0.5, 0.7, 0.9]}),
        pd.Series([0, 0, 1, 1]),
    ),
]
